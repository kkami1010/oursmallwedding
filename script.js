...
(function () {
  ...
  function initRsvp() {
    ...
    if (!rsvp || rsvp.enabled !== true || !rsvp.url) {
      section.hidden = true;
      return;
    }

    $('#rsvpTitle').textContent = rsvp.title || '참석 여부';
    $('#rsvpDescription').textContent = rsvp.description || '';
    $('#rsvpButton').textContent = rsvp.buttonLabel || '참석 여부 전달하기';
